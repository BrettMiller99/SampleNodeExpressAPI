...
Telemetry-Driven Optimization
     - When asking for performance optimization, first request performance data for the endpoint or operation.  
     - A good prompt to use is: "Could you analyze this endpoint's performance data to identify where bottlenecks are occurring before suggesting optimizations?"
...
Optimization Validation
     - Whenever implementing a performance optimization, add appropriate instrumentation to validate the improvement.
